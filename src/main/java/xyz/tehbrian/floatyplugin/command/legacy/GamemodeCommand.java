...
@CommandPermission("floatyplugin.gamemode")
...
public class GamemodeCommand extends BaseCommand {
    ...
    public void onSurvival(final Player player, @Optional @CommandPermission("floatyplugin.gamemodeother") final OnlinePlayer target) {
    ...
    @CommandCompletion("@players")
    public void onCreative(final Player player, @Optional @CommandPermission("floatyplugin.gamemodeother") final OnlinePlayer target) {
        final Player targetPlayer = target == null ? player : target.getPlayer();
    ...
    @CommandCompletion("@players")
    public void onAdventure(final Player player, @Optional @CommandPermission("floatyplugin.gamemodeother") final OnlinePlayer target) {
        final Player targetPlayer = target == null ? player : target.getPlayer();
